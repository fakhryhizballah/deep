...
from connection.redis_conn import get_redis_connection,download_image,DecodingImage
...
@router.get("/face/findID/base64")
def find_face_by_url(base64: str):
  image_path = DecodingImage(base64)
  result = identify_face_imread_with_vector_search(image_path)
  if os.path.exists(image_path):
       os.remove(image_path)
